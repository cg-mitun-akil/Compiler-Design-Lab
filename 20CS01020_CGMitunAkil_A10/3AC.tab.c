...
{
       0,    47,    47,    49,    52,    53,    56,    58,    61,    62,
      63,    64,    65,    67,    69,    75,    79,    78,    91,    90,
      99,   106,   111,   117,   105,   125,   131,   137,   143,   149,
     157,   158,   159,   160,   161,   162,   165,   171,   177,   183,
     188,   193,   198,   203,   208,   209
};
#endif
...
static const char *const yytname[] =
{
  ...
  "prog", "Entire_code", "List_of_statements", "Statement",
  "assignment_Statement", "read_Statement", "print_Statement",
  "if_Statement", "$@1", "elsePart", "$@2", "while_Statement", "$@3",
  "$@4", "$@5", "Condition", "Relation_operator", "Expression", 0
};
#endif
...
/* Line 1455 of yacc.c  */
#line 97 "3AC.y"
    { fprintf(output, " L%d : ", if_true_ref); ;}
    break;
